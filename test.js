...
contract('AuctionContract', function (accounts) {
  ...
  it("Should NOT allow to bid more than remaining tokens", function() {
    ...
    ***********/
    return /*<CODE HERE>*/auctionInstance.bid(itemId=0, count=6,{from:accounts[1]})
    .then(function (result) {
      /*
  ...
  it("Should set winners", function() {
    ...
    ***********/
    ...
    .then(function(result) {
      ...
      ***********/
      /*<CODE HERE>*/assert.notEqual(result, '0x0000000000000000000000000000000000000000' , message);
      /**********
      ...
      ***********/
      return /*<CODE HERE>*/auctionInstance.revealWinners({from:accounts[3]})
    }).then(function(result) {
      /**********
